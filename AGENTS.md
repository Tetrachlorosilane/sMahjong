...
> ⏱ 全量自检约 **125 秒**（2026-09 规则收口之后 **1019** 项；审计三轮之后是 944 项 / 115 秒）
...
**实测通过**：服务端自检 **1019** 项（含训练接口不变式 + 振听三条 + teacher 取舍 + 批次一的口径修复 + 《雀魂》的国士抢暗杠 / 天和国士 + 包牌多责任者列表）、客户端自检 **678** 项、§4 的全部 L3 工具（含 `replay-test`、
